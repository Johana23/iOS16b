...
class HomeScreenViewController: UIViewController , UITableViewDataSource,UITableViewDelegate {
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.lblContent.text = "Nombre : \(student.Name)  \n  Materia : \(student.Marks)"
    ...
    @IBAction func btnDeleteClicked(sender: AnyObject) {
        ...
        if isDeleted {
            Util.invokeAlertMethod("", strBody: "Registro borrado.", delegate: nil)
        } else {
            Util.invokeAlertMethod("", strBody: "Error al borrar.", delegate: nil)
        }
        self.getStudentData()
    }
